...
1. Launch the [ROAR web application](https://web.stanford-roar.com) and log in. 
...
1. Click *Enter Bot* next to My Bots.
1. Choose *Websocket Connection* as your bot connection type, give it a name and submit the bot.
